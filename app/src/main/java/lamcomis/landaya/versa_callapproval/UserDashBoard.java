...
public class UserDashBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabadapter.addFragment(new ActiveCallApproval(), "Call Approval");
        tabadapter.addFragment(new SendCallApproval(), "Send Call Approval");
        ...
        logout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_UP){
                    ...
                    PromptActivity.showAlert(UserDashBoard.this, "logout");
                }
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if(!newPassword.getText().toString().equals("")&&!confirmPassword.getText().toString().equals("")){
                    ...
                    if(newPassword.getText().toString().equals(confirmPassword.getText().toString()) ){
                        ...
                        PromptActivity.showAlert(UserDashBoard.this, "dont_match");
                    }
                }
                else{
                    PromptActivity.showAlert(UserDashBoard.this, "empty");
                }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, CHANGE_PASSWORD, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.trim().contains("success")) {
                    PromptActivity.showAlert(UserDashBoard.this, "success_changepass");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                       PromptActivity.showAlert(UserDashBoard.this, "error");
    ...
    public void onBackPressed() {
        PromptActivity.showAlert(UserDashBoard.this, "back");
    }
}
